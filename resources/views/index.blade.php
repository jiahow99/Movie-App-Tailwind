        ...
        <div class="popular-movies">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-10">
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300 duration-500">Joker</a>
                    </div>
                    <div class="flex items-center text-gray-400">
                        <span class="text-orange-400"><i class="fa-solid fa-star"></i></span>
                        <span class="ml-1">85%</span>
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ asset('image/sonic.jpg') }}" class="transition ease-in-out duration-500 hover:scale-105 hover:opacity-60" alt="parasite">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300 duration-500">Sonic the Hedgehog</a>
                    </div>
                    <div class="flex items-center text-gray-400">
                        <span class="text-orange-400"><i class="fa-solid fa-star"></i></span>
                        <span class="ml-1">85%</span>
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ asset('image/frozen2.jpg') }}" class="transition ease-in-out duration-500 hover:scale-105 hover:opacity-60" alt="parasite">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300 duration-500">Frozen II</a>
                    </div>
                    <div class="flex items-center text-gray-400">
                        <span class="text-orange-400"><i class="fa-solid fa-star"></i></span>
                        <span class="ml-1">85%</span>
