                ...
                <div class="flex items-center text-gray-400 mt-1">
                    ...
                    @else
                        <span class="ml-5 mr-3">
                            ...
                            @else
                                <i x-on:click="loginModal = true" class="fa-solid fa-thumbs-up fa-xl text-green-700 hover:scale-125 cursor-pointer"></i>
                            @endauth
                        </span>
                        <span >
                            <!-- Rate bad -->
                            ...
                            @else
                                <i x-on:click="loginModal = true" class="fa-solid fa-thumbs-down fa-xl text-red-500 hover:scale-125 cursor-pointer"></i>
                            @endauth
                        </span>
                    @endisset
