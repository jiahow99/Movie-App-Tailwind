...
@section('content')
    <div class="fixed w-full h-full inset-x-0">
        <iframe class="mx-auto 2xl:w-[1200px] 2xl:h-[700px] lg:w-[1000px] lg:h-[600px] md:w-[800px]  md:h-[400px]" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}?autoplay=1" 
