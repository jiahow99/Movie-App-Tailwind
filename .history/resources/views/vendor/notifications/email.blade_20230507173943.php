...
<html lang="en">
    ...
    <body>
        <div class="flex items-center justify-center min-h-screen p-5 bg-blue-100 min-w-screen">
            <div class="relative max-w-xl p-8 text-center text-gray-800 bg-gray-900 font-sans shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                ...
                <div class="my-4">
                    <a href="{{ $actionUrl }}">
                        <button class="px-2 py-2 text-black bg-slate-300 rounded">Click to Verify Email</button>
                    </a>
                    <p class="mt-8 text-sm">If you’re having trouble clicking the "Verify Email Address" button, copy
                        ...
                        <a href="{{ $actionUrl }}" class="text-blue-600 underline whitespace-nowrap">{{ $actionUrl }}</a>
                    </p>
                </div>
            </div>
        </div>
