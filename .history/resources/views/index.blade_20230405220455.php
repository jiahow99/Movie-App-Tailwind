...
@section('content')
    ...
    <script>
        ...
        on: {
            reachEnd: function() {
            this.params.direction = this.params.direction === 'horizontal' ? 'horizontal-reversed' : 'vertical-reversed';
            this.changeDirection(this.params.direction);
            this.update();
            },
            reachBeginning: function() {
            this.params.direction = this.params.direction === 'horizontal-reversed' ? 'horizontal' : 'vertical';
            this.changeDirection(this.params.direction);
            this.update();
            }
        },
