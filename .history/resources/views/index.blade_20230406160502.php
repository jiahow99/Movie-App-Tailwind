...
@section('content')
    ...
    <div class="container mx-auto px-4 pt-16">
        ...
        <div class="now-playing mt-10">
            <div class="flex justify-between">
                ...
                <div class="swiper-buttons my-auto select-none">
                    <div class="w-1/12 inline mr-3"><i class="fa-solid fa-caret-left text-black text-xl md:text-2xl xl:text-3xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 thumbnail-prev"></i></div>
                    <div class="w-1/12 inline mr-2"><i class="fa-solid fa-caret-right text-black text-xl md:text-2xl xl:text-3xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 thumbnail-next"></i></div>
                </div>
            </div>
            {{-- Swiper --}}
    ...
    <!-- Initialize Swiper -->
    <script>
        var popularSwiper = new Swiper(".nowPlaying", {
        slidesPerView: 5,
        rewind: true,
