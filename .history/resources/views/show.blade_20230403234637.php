...
<div x-data="{
    ...
    isOpen: false,
    videoSrc: 'https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}',
}">
    {{-- Video Modal --}}
    <div class="fixed w-full h-full inset-x-0" x-show="isOpen">
        <div class="
        mx-auto relative
        ...
        w-[350px] h-[200px]">
            <iframe class="w-full h-full" x-bind:src="videoSrc + (isOpen ? '?autoplay=1 : '')" 
            allow="autoplay; encrypted-media" allowfullscreen x-on:load="true"></iframe>
        </div>
    </div>
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                <div class="mt-12">
                    ...
                    x-show="isDesktop">
                        ...
                        <span class="font-bold" x-on:click="isOpen = true">Play Trailer</span>
                    </span>
                    {{-- Mobile "Play Trailer" --}}
                    <a 
