...
<div class="register-form w-full h-full flex justify-center align-middle">
    <div>
        <!-- login modal -->
        <div class="register-box w-[400px] md:w-[600px] xl:w-[800px] mt-12 pt-2 pb-10 px-8">
            ...
            <div class="xl:flex justify-between gap-5">
                ...
                <!-- Start Social Login -->
                <div class="basis-1/2 mt-10 xl:mt-0 border-t xl:border-l border-neutral-600 xl:pl-5 ">
