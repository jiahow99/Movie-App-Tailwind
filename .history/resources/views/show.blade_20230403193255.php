...
@section('content')
    <div class="fixed w-full h-full inset-x-0">
        <iframe class="mx-auto 2xl:mt-20 2xl:w-[1200px] 2xl:h-[700px] lg:w-[1000px] lg:h-[600px] md:w-[800px]  md:h-[400px]" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}?autoplay=1" 
         allow="autoplay; encrypted-media" autoplay allowfullscreen></iframe>
    </div>
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row xl:mx-0">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <button class="bg-gray-700 px-6 py-3" type="button" data-modal-toggle="default-modal">Play</button>
                </div>
            </div>
        </div>
    </div>
