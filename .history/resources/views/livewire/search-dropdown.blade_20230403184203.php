...
>
    ...
    <div class="search-results absolute w-72 bg-gray-800 rounded-lg mt-2 z-50" >
        <ul class="bg-gray-700">
            ...
            <button class="btn btn-primary btn-lg" href="#" data-toggle="modal" data-options="{'iframeSrc':'https://www.youtube.com/embed/rYQJPhAqOHU', 'size': 'xl'}">Extra Large Modal</button>
