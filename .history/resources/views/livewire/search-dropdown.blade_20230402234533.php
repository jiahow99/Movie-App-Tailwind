<div class="relative">
    ...
    <div class="search-results absolute w-64 bg-gray-800 rounded-lg mt-2 z-50">
                ...
                @if ($searchResults->isNotEmpty())
                    @foreach ($searchResults as $result)
                        <li class="border-b border-gray-700">
                            <a href="{{ route('movie.show', $result['id']) }}" class="block hover:bg-gray-800 px-3 py-3
                            duration-200 flex items-center">
                            <img src="https://image.tmdb.org/t/p/w500/"{{ $result['poster_path'] }} alt="{{ $result['title'] }}_image">
                            </a>
                        </li>
                    @endforeach
                @else
