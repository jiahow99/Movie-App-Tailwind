...
@section('content')
    <div class="fixed w-full h-full inset-x-0 hidden">
        <iframe class="mx-auto" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}?autoplay=1" 
        width="1000" height="600" allow="autoplay; encrypted-media" autoplay allowfullscreen></iframe>
    </div>
