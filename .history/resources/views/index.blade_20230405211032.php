        ...
        <div class="popular-movies">
            <div class="flex justify-between">
                ...
                <div class="swiper-buttons my-auto">
                    <div class="w-1/12 inline mr-3"><i class="fa-solid fa-caret-left text-black text-xl md:text-2xl xl:text-3xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 thumbnail-prev no-swiping cursor-not-allowed"></i></div>
