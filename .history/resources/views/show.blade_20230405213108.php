    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }">
        ...
        <div class="fixed inset-0 z-20 bg-black/70" x-show="imageModalOpen" x-transition>
            <div class="absolute top-8 right-20 z-20 cursor-pointer text-4xl ">
                <i class="fa-sharp fa-solid fa-xmark hover:rotate-90 hover:scale-150 duration-300" x-on:click="imageModalOpen = false; swiper.destroy();"></i>
            </div>
            <div class="flex justify-center align-middle w-12/12 md:w-11/12 xl:w-8/12 mx-auto mt-72 md:mt-56 xl:mt-36" @click.outside="imageModalOpen = false; swiper.destroy();">
