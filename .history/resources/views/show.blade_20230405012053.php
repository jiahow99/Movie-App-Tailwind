    ...
    x-data="{ imageModalOpen: true, imageSrc: '' }">
        ...
        <div class="fixed inset-0 z-20 bg-black/70" x-show="imageModalOpen" x-transition>
            ...
            <div class="flex justify-center align-middle w-8/12 mx-auto mt-36">
                <div class="my-auto mx-5"><i class="fa-solid fa-caret-left text-gray-800 text-4xl cursor-pointer rounded-full bg-white px-2 hover:text-white hover:bg-slate-700 duration-150"></i></div>
                ...
                <div class="my-auto mx-5"><i class="fa-solid fa-caret-right text-gray-800 text-4xl cursor-pointer rounded-full bg-white px-2 hover:text-white hover:bg-slate-700 duration-150"></i></div>
            </div>
        </div>
    </div>
</div>
