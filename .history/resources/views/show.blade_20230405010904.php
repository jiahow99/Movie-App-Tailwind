...
<div x-data="{
    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }">
        ...
        {{-- Thumbnail Modal --}}
        <div class="fixed flex inset-0 z-20 bg-black/70" x-show="imageModalOpen" x-transition>
            ...
            <div class="swiper mySwiper w-[1000px]" x-show="imageModalOpen" style="display: none">
                <div class="swiper-wrapper pointer-events-none">
                  <div class="swiper-slide pointer-events-none"><img src="{{ asset('image/image1.jpg') }}" class="pointer-events-none" alt=""></div>
                  <div class="swiper-slide pointer-events-none"><img src="{{ asset('image/image1.jpg') }}" class="pointer-events-none" alt=""></div>
                  <div class="swiper-slide pointer-events-none"><img src="{{ asset('image/image1.jpg') }}" class="pointer-events-none" alt=""></div>
                  <div class="swiper-slide pointer-events-none"><img src="{{ asset('image/image1.jpg') }}" class="pointer-events-none" alt=""></div>
                  <div class="swiper-slide pointer-events-none"><img src="{{ asset('image/image1.jpg') }}" class="pointer-events-none" alt=""></div>
