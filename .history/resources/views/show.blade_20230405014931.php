...
<div x-data="{
    ...
    x-data="{ imageModalOpen: false, imageSrc: '', activeImageIndex: null, swiper: null }">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Screenshots</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap:0 xl:gap-10" x-on:click="activeImageIndex = $event.target.getAttribute('data-index'); swiper && swiper.focusIndex = activeImageIndex">
