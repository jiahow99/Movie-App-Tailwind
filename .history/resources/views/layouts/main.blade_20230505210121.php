    ...
    <nav id="navbar" class="border-b border-gray-800 z-50">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col lg:flex-row items-center mt-3 lg:mt-0 gap-4">
                ...
                @endif
                <!-- Account -->
                <div class="relative mt-3 lg:mt-0 w-auto text-right">
                    ...
                    <ul class="absolute z-50 bg-gray-600 rounded-md shadow-xl text-left mt-2 w-full">
                        <a href="#">
                            <li class="block text-sm pl-2 pr-2 text-white hover:bg-gray-700 py-2 rounded-md">Account setting</li>
                        </a>
                        <a href="{{ route('logout') }}">
                            <li class="block text-sm pl-2 pr-2 text-white hover:bg-gray-700 py-2 rounded-md">Logout</li>
                        </a>
                    </ul>
                </div>
