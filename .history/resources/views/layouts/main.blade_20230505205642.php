        ...
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col lg:flex-row items-center mt-3 lg:mt-0 gap-4">
                ...
                <div class="relative xl:ml-4 mt-3 lg:mt-0 w-40 text-right">
                    ...
                    <ul class="absolute z-50 bg-gray-600 rounded-md shadow-xl py-2 text-left mt-2">
                        <a href="#"><li class="block pl-2 pr-10 text-white hover:bg-gray-700">Account setting</li></a>
                        <a href="{{ route('logout') }}"><li class="block pl-2 pr-10 text-white hover:bg-gray-700">Logout</li></a>
                    </ul>
                </div>
