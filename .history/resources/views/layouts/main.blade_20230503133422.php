        ...
        <div class="login-box">
            ...
            <form>
                ...
                <div class="inline-flex items-center justify-center w-full">
                    <hr class="w-6/6 h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">
                    <span class="absolute px-3 font-medium text-gray-500 -translate-x-1/2 bg-[#252222f2] left-1/2 dark:text-white dark:bg-gray-900">or</span>
                </div>
            </form>
        </div>
    </div>
