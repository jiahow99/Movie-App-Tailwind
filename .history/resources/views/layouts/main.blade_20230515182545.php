...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Footer -->
    <div class="footer w-full bg-slate-800 py-8 px-4 flex justify-between">
        <div class="w-1/4">
            <a href="{{ route('movies.index') }}" class="flex align-middle mb-3">
                <img src="data:image/png;base64," alt="movie_app_logo">
        ...
        <div class="w-1/3">
            <h2 class="font-bold text-lg">Developer Information :</h2>
            <div class="developer-name flex gap-2 justify-start text-slate-400">
                <span>Name :</span>
                <span class="font-bold">Liong Kah How</span>
            </div>
            <div class="developer-age flex gap-2 justify-start text-slate-400">
                <span>Age :</span>
                <span class="font-bold">21</span>
            </div>
            <div class="developer-degree flex gap-2 justify-start text-slate-400">
                <span>Highest Achievement :</span>
                <span class="font-bold">Bachelor's Information Technology</span>
            </div>
            <div class="developer-involvement flex gap-2 justify-start text-slate-400">
                <span>Involvement :</span>
                <span class="font-bold">Frontend & Backend</span>
            </div>
            <div class="developer-social flex gap-2">
                <div class="linkedin">
                    <div class="rounded-md bg-transparent border-2 border-slate-300 px-2 py-1">
                        <i class="fa-brands fa-linkedin-in"></i>
                    </div>
                </div>
                <div class="facebook">
                    <div class="rounded-md bg-transparent border-2 border-neutral-600 px-2 py-1">
