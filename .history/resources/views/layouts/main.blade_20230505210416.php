...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Start Navbar -->
    <nav id="navbar" class="border-b border-gray-800 z-50" x-data="{ account_dropdown: false }">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col lg:flex-row items-center mt-3 lg:mt-0 gap-4">
                ...
                @endif
                <!-- Account -->
                <div class="relative mt-3 lg:mt-0 w-32 text-right">
                    <i class="fa-solid fa-user rounded-full border-white border-2 p-1 cursor-pointer"></i>
                    <ul class="absolute z-50 bg-gray-600 rounded-md shadow-xl text-left mt-2 w-full hidden" x-show="account_dropdown">
                        <a href="#">
                            <li class="block text-sm font-semibold pl-2 pr-2 text-white hover:bg-gray-700 py-2 rounded-md">Account setting</li>
                        </a>
                        <a href="{{ route('logout') }}">
                            <li class="block text-sm font-semibold pl-2 pr-2 text-white hover:bg-gray-700 py-2 rounded-md">Logout</li>
                        </a>
                    </ul>
                </div>
                <div onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</div>
