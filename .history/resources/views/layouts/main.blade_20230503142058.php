...
<body class="relative font-sans bg-gray-900 text-white">
    ...
    <div class="fixed z-50 inset-0 flex items-center justify-center">
        <div class="login-box">
            <span class="fixed top-0 right-0"><i class="fa-regular fa-xmark"></i></span>
            <h1 class="text-center text-2xl pb-10 tracking-widest font-bold">Login</h1>
            <form>
                <!-- Username -->
                ...
                <div class="text-center">
                    <div class="w-full py-1 px-10 mx-auto login-btn-2">
                        Login
                    </div>
                </div>
                <!-- Sign up -->
