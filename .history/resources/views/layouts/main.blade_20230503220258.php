...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Scroll Top -->
    <div class="scroll-to-top fixed bottom-14 right-14 z-50">
        {{-- <span class="p-5 bg-gray-700 rounded-full shadow-2xl animate-ping">
            <i class="fa-solid fa-angle-up fa-2xl text-white m-0 p-0"></i>
        </span> --}}
        <span class="animate-ping  h-full w-full rounded-full bg-sky-400 opacity-75"></span>
    </div>
