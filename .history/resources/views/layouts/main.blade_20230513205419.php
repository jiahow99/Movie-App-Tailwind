...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <nav id="navbar" class="relative border-b border-gray-800 z-50" x-data="{ account_dropdown: false }">
        <!-- Hamburger toggler -->
        {{-- <div id="ham-menu" class="absolute top-4 right-6 block lg:hidden bg-gray-700 px-3 py-2 rounded-lg">
        ...
        <div class="flex justify-between align-middle">
            ...
            <div>
                <div id="ham-menu" class="block lg:hidden bg-gray-700 px-3 py-2 rounded-lg">
                    <i class="fa-solid fa-bars"></i>
                </div>  
            </div>
        </div>
        ...
        <!-- Hamburger Menu -->
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6 hidden">
