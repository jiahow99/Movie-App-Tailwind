...
<body class="relative font-sans bg-gray-900 text-white">
    ...
    <!-- Start Login Modal -->
    <div class="fixed inset-0 w-screen h-screen bg-gray-800 opacity-90 z-50 flex justify-center align-middle ">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-9/12 h-fit">
