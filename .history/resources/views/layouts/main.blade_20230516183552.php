...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div id="search-modal-container">
        <div class="modal-background">
            <div class="search-input relative mt-14 bg-slate-400">
                <input type="text" class="bg-transparent rounded-full w-20">
                <span class="absolute h-[3px] w-full bg-white bottom-0"></span>
            </div>
        </div>
    </div>
