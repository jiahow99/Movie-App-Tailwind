...
<body class="relative font-sans bg-gray-900 text-white">
    ...
    <div class="fixed inset-0 z-40">
        <div class="absolute inset-0 bg-gray-800 opacity-50 blur"></div>
    </div>

  
    <!-- HTML for the login modal -->
<div class="fixed z-50 inset-0 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96 h-auto">
      <h2 class="text-gray-800 font-bold text-2xl mb-4">Login</h2>
