...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full bg-slate-800 py-8 px-4 lg:flex justify-between">
        ...
        <!-- Developer Info -->
        <div class="developer-info lg:w-1/3 text-center">
            <h2 class="font-bold text-lg mt-6">Developer Information :</h2>
            <div class="developer-name flex gap-2 justify-center text-slate-400">
                <span>Name :</span>
