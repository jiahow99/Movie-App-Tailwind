...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full py-8 px-4 flex items-center">
        <div class="w-1/4">
            <a href="{{ route('movies.index') }}" class="flex justify-center align-middle">
                <img src="data:image/png;base64," alt="movie_app_logo">
                <span class="no-underline font-bold ml-2 my-auto text-lg">{{ config('app.name') }}</span>
            </a>
            <div>Whether you're a cinephile, a casual moviegoer, or someone in search of their next movie night selection, our website has something for everyone. Sit back, relax, and let our movie database and trailer feature enhance your movie-watching experience.</div>
        </div>
    </div>
