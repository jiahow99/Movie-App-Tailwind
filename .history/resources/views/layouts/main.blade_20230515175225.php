...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full py-8 px-4 flex items-center">
        <div class="w-1/4 text-left">
            ...
            <div class="lead">Whether you're a cinephile, a casual moviegoer, or someone in search of their next movie night selection, our website has something for everyone. Sit back, relax, and let our movie database and trailer feature enhance your movie-watching experience.</div>
        </div>
    </div>
