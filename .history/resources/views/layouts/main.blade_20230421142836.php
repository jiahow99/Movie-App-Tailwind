...
<body class="relative font-sans bg-gray-900 text-white">
    <!-- Start Preloader -->
    <div id="loader" class="fixed w-screen h-screen z-50">
        <div class="demo">
            <div class="rings">
                <div class="rings">
                    <div class="logo">  
    ...
    <script>
        // set a minimum time to display the loader animation
        var loaderTimeout = setTimeout(showPage, 2000);

        // fade out the loader animation when the page is ready
        function showPage() {
