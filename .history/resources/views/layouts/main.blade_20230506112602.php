                ...
                @if (Auth::check())
                    <div class="relative mt-3 lg:mt-0 w-32 text-right select-none mr-10">
                        <div class="flex justify-end align-center gap-2">
                            <i class="fa-solid fa-user rounded-full border-white border-2 p-1 cursor-pointer" x-on:click="account_dropdown = !account_dropdown" @click.outside="account_dropdown = false"></i>
                            <i class="fa-solid fa-caret-down fa-xl my-auto cursor-pointer" x-on:click="account_dropdown = !account_dropdown" @click.outside="account_dropdown = false"></i>
                        </div>
