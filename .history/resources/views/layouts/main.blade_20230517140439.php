...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <nav id="navbar" class="relative border-b border-gray-800 z-50" x-data="{ account_dropdown: false }">
        ...
        <div class="container mx-auto hidden lg:flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col lg:flex-row items-center mt-3 lg:mt-0 gap-4">
                <!-- Search -->
                {{-- <livewire:search-dropdown /> --}}
                <div id="one" class="relative flex search-box items-center justify-end search cursor-pointer">
    ...
    <!-- Search Modal -->
    <div id="search-modal-container" class="one">
        <div class="modal-background px-52">
            <!-- Search -->
            <div class="search-input relative mt-14 w-fit mx-auto">
                {{-- <livewire:search-dropdown /> --}}
                <input type="text" class="pr-80 py-2 pl-4 bg-transparent rounded-full focus:outline-none" placeholder="Search a movie">
                <div class="line hidden"></div>
            </div>
            <!-- Results -->
            <div class="search-results h-100 ">
                <div class="w-full bg-slate-600/30 mt-5 px-10 py-4 flex">
                    <div class="w-2/12">
        ...
        <!-- Close Btn -->
        <span id="search-close" class="close absolute top-10 right-10 text-gray-300 cursor-pointer hover:rotate-90 hover:scale-150 transition duration-200" x-on:click="loginModal = false; resetInput();">
            <i class="fa-solid fa-xmark fa-2xl"></i>
        </span>
    </div>
