...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div id="search-modal-container" class="one">
        <div class="modal-background">
            <div class="search-input relative mt-14 w-fit mx-auto focus:outline-none">
                {{-- <livewire:search-dropdown /> --}}
                <input type="text" class="pr-80 text-black py-2 pl-2 bg-gray-700 rounded-full" placeholder="Search a movie">
            </div>
        </div>
    </div>
