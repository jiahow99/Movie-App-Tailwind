...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Scroll Top -->
    <div class="scroll-to-top fixed bottom-24 right-28 z-50">
        <div class="relative">
            <span class="absolute p-5 bg-gray-600 rounded-full shadow-2xl z-20 cursor-pointer hover:bg-gray-700" x-on:click="window.scrollTo({ top: 0, behavior: 'smooth' })" x-show="window.pageYOffset > 100">
