...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Footer -->
    <div class="footer w-full bg-slate-800 py-8 px-4 lg:flex justify-between">
        <!-- Website Info -->
        <div class="website-info lg:w-1/4">
            <a href="{{ route('movies.index') }}" class="flex align-middle mb-3 justify-center lg:justify-start">
                <img src="data:image/png;base64," alt="movie_app_logo">
                <span class="no-underline font-bold ml-2 my-auto text-lg">{{ config('app.name') }}</span>
            </a>
            <div class="leading-relaxed text-slate-400">Whether you're a cinephile, a casual moviegoer, or someone in search of their next movie night selection, our website has something for everyone. Sit back, relax, and let our movie database and trailer feature enhance your movie-watching experience.</div>
        </div>
        <!-- Developer Info -->
        <div class="developer-info lg:w-1/3">
            <h2 class="font-bold text-lg mt-6 lg:mt-0 text-center lg:text-left">Developer Information :</h2>
            <div class="developer-name flex gap-2 justify-center lg:justify-start text-slate-400">
                <span>Name :</span>
                <span class="font-bold">Liong Kah How</span>
            </div>
            <div class="developer-age flex gap-2 justify-center lg:justify-start text-slate-400">
                <span>Age :</span>
                <span class="font-bold">21</span>
            </div>
            <div class="developer-degree flex gap-2 justify-center lg:justify-start text-slate-400">
                <span>Highest Achievement :</span>
                <span class="font-bold">Bachelor's Information Technology</span>
            </div>
            <div class="developer-involvement flex gap-2 justify-center lg:justify-start text-slate-400">
                <span>Involvement :</span>
                <span class="font-bold">Frontend & Backend</span>
            </div>
            <div class="developer-social flex gap-3 mt-2 justify-center lg:justify-start">
                <div class="linkedin">
        ...
        <div class="contact-info lg:w-1/5">
            <h2 class="font-bold text-lg mt-6 lg:mt-0 text-center lg:text-left">Contact Me :</h2>
            <div class="developer-degree flex gap-2 justify-center lg:justify-start text-slate-400">
                <span>Email :</span>
                <span class="font-bold text-blue-600 underline underline-offset-3">jia_how99@hotmail.com</span>
            </div>
        </div>
    </div>
