    ...
    <div class="footer w-full bg-slate-800 py-8 px-4 lg:flex justify-between">
        ...
        <div class="website-info lg:w-1/4">
            <a href="{{ route('movies.index') }}" class="flex align-middle mb-3 justify-center lg:justify-start">
                <img src="data:image/png;base64," alt="movie_app_logo">
                <span class="no-underline text-sm font-bold ml-2 my-auto text-lg">{{ config('app.name') }}</span>
            </a>
        ...
        <div class="developer-info lg:w-1/3">
            ...
            <div class="developer-age flex gap-2 justify-center lg:justify-start text-slate-400 text-sm">
                <span>Age :</span>
