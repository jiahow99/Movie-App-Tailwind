...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div id="search-modal-container" class="one">
        ...
        <!-- Close Btn -->
        <span id="search-close" class="close fixed top-5 right-5 text-gray-300 cursor-pointer hover:rotate-90 hover:scale-150 transition duration-200" x-on:click="loginModal = false; resetInput();">
            <i class="fa-solid fa-xmark fa-2xl"></i>
        </span>
    </div>
