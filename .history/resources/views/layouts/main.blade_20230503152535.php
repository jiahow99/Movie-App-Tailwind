...
<body class="relative font-sans bg-gray-900 text-white" x-data="{ loginModal: false }">
    ...
    <!-- login modal -->
    <div class="fixed z-50 inset-0 flex items-center justify-center" x-show="loginModal" x-on:click.outside="loginModal = false" style="display: none">
        <div class="login-box">
            <!-- Close -->
            <span class=" close fixed top-5 right-5 text-gray-300 cursor-pointer hover:rotate-90 hover:scale-150 transition duration-200">
