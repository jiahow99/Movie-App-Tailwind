    ...
    <div class="bg-slate-600 bg-opacity-90 rounded-2xl shadow-2xl p-6 w-4/12 h-fit text-white">
      ...
      <form class="space-y-4">
        <div>
          ...
          <input type="email" id="email" name="email" class="mt-2 w-full border border-gray-400 py-2 pl-4 rounded-md text-black" placeholder="name@example.com">
        </div>
        <div>
          <label for="password" class="block font-bold pl-2">Password</label>
          <input type="password" id="password" name="password" class="w-full border border-gray-400 py-2 pl-2 rounded-md text-black">
        </div>
