...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <!-- Scroll Top -->
    <div class="scroll-to-top fixed bottom-20 right-20 z-50">
        <div class="relative">
            <span class="absolute p-5 bg-gray-700 rounded-full shadow-2xl z-20">
                <i class="fa-solid fa-angle-up text-white m-0 p-0 fa-2xl"></i>
            </span>
            <span class="absolute p-5 bg-gray-700 rounded-full animate-ping z-10">
                <i class="fa-solid fa-angle-up text-white m-0 p-0 fa-2xl"></i>
            </span>
        </div>
    </div>
