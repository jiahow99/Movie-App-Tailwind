...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full bg-slate-800 mt-20 py-8 px-4 lg:flex justify-between">
        ...
        <div class="developer-info lg:w-1/3">
            <h2 class="font-bold text-lg mt-6 lg:mt-0 text-center lg:text-left text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-red-600">Developer Information :</h2>
