    ...
    <nav id="navbar" class="border-b border-gray-800 z-50">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col lg:flex-row items-center mt-3 lg:mt-0 gap-4">
                ...
                <!-- Login -->
                <div class="login-btn px-7 py-2 bg-gray-700 text-gray-300">
                    Login
                </div>
                <!-- Account -->
        ...
        <div class="login-box">
            ...
            <form>
              ...
              <div class="text-center">
                  <button class="m-0 p-0 px-5 py-2 login-btn bg-white text-black outline-none border-transparent">Login</button>
              </div>
            </form>
          </div>
    </div>
