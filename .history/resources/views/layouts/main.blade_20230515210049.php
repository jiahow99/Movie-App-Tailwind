...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full bg-slate-800 py-8 px-4 lg:flex justify-between">
        ...
        <div class="developer-info lg:w-1/3">
            ...
            <div class="developer-name flex gap-2 justify-center lg:justify-start text-slate-400 text-sm mt-2">
                <span>Name :</span>
        ...
        <div class="contact-info lg:w-1/5">
            ...
            <div class="developer-degree flex gap-2 justify-center lg:justify-start text-slate-400 text-sm mt-2">
                <span>Email :</span>
