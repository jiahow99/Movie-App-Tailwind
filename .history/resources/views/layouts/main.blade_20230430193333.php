...
<div class="fixed z-50 inset-0 flex items-center justify-center bg-opacity-90">
    <div class="bg-slate-600 bg-opacity-90 rounded-lg shadow-2xl p-6 w-96 h-fit text-white">
