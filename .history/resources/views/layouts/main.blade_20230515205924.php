...
<body class="relative font-sans bg-gray-900 text-white" 
    ...
    <div class="footer w-full bg-slate-800 py-8 px-4 lg:flex justify-between">
        ...
        <div class="website-info lg:w-1/4">
            ...
            <div class="leading-relaxed text-slate-400 text-sm">Whether you're a cinephile, a casual moviegoer, or someone in search of their next movie night selection, our website has something for everyone. Sit back, relax, and let our movie database and trailer feature enhance your movie-watching experience.</div>
        </div>
        <!-- Developer Info -->
        <div class="developer-info lg:w-1/3">
            ...
            <div class="developer-name flex gap-2 justify-center lg:justify-start text-slate-400 text-sm ml-4">
                <span>Name :</span>
                <span class="font-bold">Liong Kah How</span>
            </div>
            <div class="developer-degree flex gap-2 justify-center lg:justify-start text-slate-400 text-sm ml-4">
                <span>Highest Achievement :</span>
                <span class="font-bold">Bachelor's Information Technology</span>
            </div>
            <div class="developer-involvement flex gap-2 justify-center lg:justify-start text-slate-400 text-sm ml-4">
                <span>Involvement :</span>
                <span class="font-bold">Frontend & Backend</span>
            </div>
            <div class="developer-social flex gap-3 mt-2 justify-center lg:justify-start ml-4">
                <div class="linkedin">
