        ...
        <div class="popular-movies">
            <div class="flex justify-between">
                ...
                <div class="swiper-buttons">
                    <div class="w-1/12 inline mr-4"><i class="fa-solid fa-caret-left text-gray-800 text-xl md:text-2xl xl:text-3xl cursor-pointer rounded-full bg-white px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 thumbnail-prev no-swiping"></i></div>
