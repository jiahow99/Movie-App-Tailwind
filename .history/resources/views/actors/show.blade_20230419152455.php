...
<div x-data="{
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            <img src="{{ $actor['profile_path'] }}" class="w-96 mx-auto xl:mx-0" alt="actor_image">
            <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                ...
                <div class="swiper-buttons select-none my-3 text-right">
                    <div class="w-1/12 inline mr-3"><i class="fa-solid fa-caret-left text-black text-xl md:text-2xl xl:text-2xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 popular-prev"></i></div>
                    <div class="w-1/12 inline mr-2"><i class="fa-solid fa-caret-right text-black text-xl md:text-2xl xl:text-2xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 popular-next"></i></div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($credits as $credit)
                                <div class="swiper-slide">
                                    <img loading="lazy" class="transition ease-in-out duration-500 hover:scale-105 hover:opacity-60 swiper-lazy"
