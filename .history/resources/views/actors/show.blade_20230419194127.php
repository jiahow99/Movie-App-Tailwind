...
<div
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            <img src="{{ $actor['profile_path'] }}" class="w-1/5 h-1/5 mx-auto xl:mx-0" alt="actor_image">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center gap-6 mt-3">
                            @isset($actor['facebook'])
                                <a href="{{ $actor['facebook'] }}" title="Facebook"><i class="fa-brands fa-facebook text-4xl text-gray-500 hover:text-white duration-300"></i></a>
                            @endisset
                            @isset($actor['twitter'])
                                <a href="{{ $actor['twitter'] }}" title="Twitter"><i class="fa-brands fa-twitter text-4xl text-gray-500 hover:text-white duration-300"></i></i></a>
                            @endisset
                            @isset($actor['instagram'])
                                <a href="{{ $actor['instagram'] }}" title="Instagram"><i class="fa-brands fa-instagram text-4xl text-gray-500 hover:text-white duration-300"></i></a>
                            @endisset
                        </div>
                    </div>
                </div>
