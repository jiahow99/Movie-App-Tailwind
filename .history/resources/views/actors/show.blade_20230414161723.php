        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            <div class="flex-none">
                ...
                <div class="flex justify-center gap-6 mt-3">
                    <a href="#" title="Facebook"><i class="fa-brands fa-square-facebook text-4xl text-gray-500 hover:text-white duration-300"></i></a>
                    <a href="#" title="Facebook"><i class="fa-brands fa-square-instagram text-4xl text-gray-500 hover:text-white duration-300"></i></a>
                    <a href="#" title="Facebook"><i class="fa-brands fa-square-twitter text-4xl text-gray-500 hover:text-white duration-300"></i></a>
