...
<div x-data="{
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            <div class="flex-none">
                <img src="{{ asset('image/actor1.jpg') }}" class="w-96 mx-auto xl:mx-0" alt="actor_image">
                <div class="flex justify-center gap-6 mt-3">
                    <a href="#" title="Facebook"><i class="fa-brands fa-square-facebook text-4xl text-gray-500 hover:text-white duration-"></i></a>
                    <a href="#" title="Facebook"><i class="fa-brands fa-instagram text-4xl text-gray-500 hover:text-white duration-"></i></a>
                    <a href="#" title="Facebook"><i class="fa-brands fa-square-twitter text-4xl text-gray-500 hover:text-white duration-"></i></a>
                    <a href="#" title="Facebook"><i class="fa-brands fa-reddit text-4xl text-gray-500 hover:text-white duration-"></i></a>
                </div>
            </div>
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                <div class="flex items-center text-gray-400 mt-2">
                    ...
                    <span class="ml-1">Feb 20, 1920 (26 years old) in Toronto, Canada</span>
                </div>

                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae aut et quae dolores doloribus qui, dolorem perferendis non praesentium odit!
                </p>
