            ...
            <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                ...
                <p class="text-gray-300 mt-8 ">
                    ...
                    @isset($actor['read_more'])
                        <span
                        :hidden="true" x-init="$el.removeAttribute('hidden')"
                        x-show="readMore"
                        ...
                        <span x-on:click="readMore = !readMore" x-show="readMore" class="mx-2 font-bold text-teal-600 hover:underline hover:text-teal-900 duration-200 ease-out underline-offset-4 cursor-pointer">Read less</span>
                    @endisset
                </p>
