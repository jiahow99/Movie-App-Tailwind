...
<div x-data="{ readMore: false }">
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            {{-- Cast history --}}
            <div class="mt-6 cast-history w-2/6 relative mr-[1000px] pb-28">
...
<script>
    ...
    var timeline_height = document.querySelector('.cast-history').offsetHeight;
    

    // Get the div element and the element inside it
    var timelineContainer = document.querySelector('.cast-history');
    var lastItem = timelineContainer.querySelector('#end_timeline');

    // Calculate the distance from the top of the div to the top of the element
    var distance = lastItem.offsetTop - timelineContainer.offsetTop;
    document.querySelector('.default-line').style.height = distance + 'px';
