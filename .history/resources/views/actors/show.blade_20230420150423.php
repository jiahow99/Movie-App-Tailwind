                ...
                <div>
                    <div class="timeline">
                        <ul>
                            ...
                            <li>
                                <div class="ml-10 pt-8 text-3xl font-bold text-slate-300 whitespace-nowrap">
                                    2021 &middot; <span class="text-lg flex flex-col align-middle">123</span>
                                </div>
                            </li>
                            <li>
                                <div class="ml-10 pt-8 text-3xl font-bold text-slate-300">2021</div>
                            </li>
                            <li>
                                <div class="ml-10 pt-8 text-3xl font-bold text-slate-300">2021</div>
                            </li>
