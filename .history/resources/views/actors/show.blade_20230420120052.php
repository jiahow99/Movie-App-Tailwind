...
<div x-data="{ readMore: false }">
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            {{-- Cast history --}}
            <div class="mt-6 cast-history w-2/6 relative">
                <div>
                    <div class="timeline">
                        <ul>
...
<script>
    ...
    var divHeight = document.getElementById("timeline").offsetHeight;
    // document.querySelector(".timeline .default-line").style.height = divHeight;
