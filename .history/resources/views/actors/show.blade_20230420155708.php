                    ...
                    <div class="timeline">
                        <ul>
                            ...
                            @foreach ($cast_movies as $movie)
                                <li>
                                    <div class="ml-10 pt-8 text-3xl font-bold text-slate-300 whitespace-nowrap relative">
                                        {{ $movie['release_year'] }} &middot; <span class="text-lg font-normal">
                                            <a href="#">
                                                <span class="relative cursor-pointer tracking-wider after:content-[''] after:bg-[rgb(2,0,36)] after:bg-gradient-to-r after:from-green-400 after:to-blue-500 after:w-[0%] after:left-0 after:-bottom-[3px] after:h-[4px] after:absolute transition-all after:duration-300 hover:after:w-[100%]"><b>{{ $movie['title'] }}</b></span>
                                            </a>
