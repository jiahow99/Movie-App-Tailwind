            ...
            <div class="flex flex-col xl:flex-row">
                ...
                <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                    <div class="xl:flex justify-between">
                        <!-- Name & age -->
                        <div>
                            <h2 class="text-4xl font-semibold" data-aos="zoom-in">{{ $actor['name'] }}</h2>
                    ...
                    <!-- Biography -->
                    <p class="text-gray-300 mt-8" data-aos="fade-left">
                        {{ $actor['biography'] }}
                    ...
                    <div class="swiper-buttons select-none mt-5 mb-3" data-aos="zoom-in">
