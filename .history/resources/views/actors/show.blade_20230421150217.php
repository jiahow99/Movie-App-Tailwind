        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="flex flex-col xl:flex-row">
                ...
                <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                    ...
                    <!-- Biography -->
                    <p class="text-gray-300 mt-8" data-aos="zoom-in">
                        {{ $actor['biography'] }}
                                ...
                                @foreach ($credits as $credit)
                                    <div class="swiper-slide m-auto">
                                        <a href="{{ route('movie.show', $credit['id']) }}">
                                            <img loading="lazy" class="known_for_movie transition ease-in-out duration-500 hover:scale-105 hover:opacity-60 h-full"
