...
<div x-data="{ readMore: false }">
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            {{-- Cast history --}}
            <div class="mt-6 cast-history w-screen relative pb-28">
                <div>
                    <div class="timeline mr-auto">
                        <ul>
                            ...
                            @foreach ($cast_movies as $movie)
                                <li>
                                    <div class="ml-10 pt-8 text-3xl font-bold text-slate-300 whitespace-nowrap relative">
                                        {{ $movie['release_year'] }} &middot; <span class="text-lg font-semibold">{{ $movie['title'] }} as {{ $movie['character'] }}</span>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
