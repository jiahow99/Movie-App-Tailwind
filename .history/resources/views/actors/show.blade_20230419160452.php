        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                ...
                <div class="swiper-buttons select-none mt-5 mb-3">
                    <div class="w-1/12 inline mr-2"><i class="fa-solid fa-caret-left text-black text-xl md:text-2xl xl:text-2xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 cr-prev"></i></div>
                    <div class="w-1/12 inline mr-2"><i class="fa-solid fa-caret-right text-black text-xl md:text-2xl xl:text-2xl cursor-pointer rounded-full bg-slate-600 px-1 xl:px-2 hover:text-white hover:bg-slate-700 duration-150 cr-next"></i></div>
                </div>
