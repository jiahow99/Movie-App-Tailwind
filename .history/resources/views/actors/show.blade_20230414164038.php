        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24 xl:pr-10">
                <div class="flex justify-between">
                    ...
                    <div>
                        <div class="text-gray-400 font-bold">Connect :</div>
                ...
                <div class="known-for">
                    <div class="swiper-wrapper">
                        <img src="{{ asset('image/frozen2.jpg') }}" alt="known_for_movie"><img src="{{ asset('image/frozen2.jpg') }}" alt="known_for_movie"><img src="{{ asset('image/frozen2.jpg') }}" alt="known_for_movie"><img src="{{ asset('image/frozen2.jpg') }}" alt="known_for_movie">
                    </div>
                </div>
...
<script>
    var knownForSwiper = new Swiper(".known-for", {
        slidesPerView: 5,
        rewind: true,
        slidesPerGroup: 5,
        spaceBetween: 30,
