...
<script>
    ...
    document.querySelector('.default-line').style.height = timeline_height-200 + 'px';

    // Get the div element and the element inside it
    var div = document.querySelector('.cast-history');
    var element = div.querySelector('#end_timeline');

    // Calculate the distance from the top of the div to the top of the element
    var distance = element.offsetTop - div.offsetTop;
</script>
