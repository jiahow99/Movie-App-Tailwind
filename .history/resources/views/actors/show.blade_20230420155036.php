                                ...
                                <li>
                                    <div class="ml-10 pt-8 text-3xl font-bold text-slate-300 whitespace-nowrap relative">
                                        {{ $movie['release_year'] }} &middot; <span class="text-lg font-normal">
                                            <a href="#" class="relative tracking-wider after:content-[''] after:bg-slate-100 after:w-[100%] after:left-0 after:-bottom-[5px] after:h-[3px] after:absolute duration-300 hover:after:w-[100%]"><b>{{ $movie['title'] }}</b> </a>
