...
@section('content')
<div class="fixed bottom-10 right-10 rounded-full bg-slate-500 px-4 pt-3 z-50 pointer-events-none m-auto">
    <i class="fa-solid fa-arrow-down-long text-4xl m-auto"></i>
</div>
