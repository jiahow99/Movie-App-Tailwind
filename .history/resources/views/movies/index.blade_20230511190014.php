...
<div class="container mx-auto px-4 pt-8">
    <div class="movies-filter w-full bg-gray-800 px-3 py-5 rounded-lg flex justify-start align-middle gap-5">
        ...
        <a href="#">
            <div class="rounded-xl text-sm font-semibold bg-slate-500 px-5 py-2 text-gray-300 underline-offset-3 cursor-pointer hover:bg-slate-700 hover:translate-y-2 duration-300 select-none">{{ $key }}</div>
        </a>
        @endforeach
    </div>
