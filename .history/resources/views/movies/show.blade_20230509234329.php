        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                @isset($movieCollections)
                    <div class="w-full outline relative">
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 p-5 bg-slate-600 rounded-full z-50">
                            <span class="fa-stack fa-4x">
                                <i class="fa fa-circle fa-stack-2x bg-slate-500"></i>
                                <i class="fa fa-lock fa-stack-1x"></i>
                            </span>
                        </div>
                        <div class="mt-10 xl:w-[600px] h-fit outline">
                            <div class="swiper movieCollections">
                                <div class="swiper-wrapper">
                                    @foreach ($movieCollections as $movieCollection)
                                        <div class="swiper-slide">
                                            <img  src="{{ $movieCollection['poster_path'] }}" alt="">
                                        </div>
                                    @endforeach
                                </div>
