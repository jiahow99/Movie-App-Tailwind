                    ...
                    <div class="flex flex-wrap justify-start align-middle gap-5 mt-2">
                        ...
                        @foreach ($regions as $key => $item)
                            <a href="{{ route('movies.region', $key) }}">
                                <div class="w-28 text-center py-1 text-sm duration-200 rounded-full bg-transparent border-2 border-gray-300 hover:-translate-y-1 hover:bg-gray-800 text-slate-300 hover:text-white hover:bg-gradient-to-r hover:from-yellow-600 hover:to-red-600 hover:border-0">
                                    {{ $key }}
                                </div>
                            </a>
                        @endforeach
