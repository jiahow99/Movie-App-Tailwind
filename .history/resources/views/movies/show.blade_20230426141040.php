...
<div x-data="{
    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots bg-black m-0 p-0">
                <div class="swiper-wrapper flex align-middle justify-center m-0 p-0">
                    <div class="swiper-slide"><img src="{{ asset('image/image2.jpg') }}" alt="" class="m-0 p-0"></div>
                    <div class="swiper-slide"><img src="{{ asset('image/image2.jpg') }}" alt="" class="m-0 p-0"></div>
                    <div class="swiper-slide"><img src="{{ asset('image/image2.jpg') }}" alt="" class="m-0 p-0"></div>
                    <div class="swiper-slide"><img src="{{ asset('image/image2.jpg') }}" alt="" class="m-0 p-0"></div>
                    <div class="swiper-slide"><img src="{{ asset('image/image2.jpg') }}" alt="" class="m-0 p-0"></div>
