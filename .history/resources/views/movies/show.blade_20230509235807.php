                ...
                @isset($movieCollections)
                    <div class="w-5/6 relative ">
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-50">
                            <i class="fa-solid fa-circle-chevron-left text-6xl opacity-70 hover:opacity-80 cursor-pointer text-zinc-500  rounded-full"></i>
                        </div>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-50">
                            <i class="fa-solid fa-circle-chevron-right text-6xl opacity-70 hover:opacity-80 cursor-pointer text-zinc-500  rounded-full"></i>
                        </div>
