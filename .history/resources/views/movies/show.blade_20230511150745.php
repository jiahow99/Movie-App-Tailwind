    ...
    <div class="movie-cast border-b border-gray-800" x-data="{actorNavigation: false}" x-on:mouseenter="actorNavigation = true" x-on:mouseleave="actorNavigation = false">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="relative w-full mt-3">
                ...
                <!-- Prev -->
                <div class="absolute left-0 top-1/2 transform -translate-y-1/2 z-50" x-show="actorNavigation" x-transition>
                ...
                <!-- Next -->
                <div class="absolute right-0 top-1/2 transform -translate-y-1/2 z-50" x-show="actorNavigation" x-transition>
