...
@section('content')
    <div class="container mx-auto px-4 pt-16">
        <!-- Filter (regions) -->
        <div class="w-full py-3 px-5 bg-gray-600 rounded-md">
            <div class="font-bold">Countries :</div>
            <div class="flex justify-start align-middle gap-5 mt-2">
                <div class="px-3 py-1 duration-300 hover:-translate-y-1 bg-gray-500 rounded-full underline pointer-events-none">
                    All
                </div>
                @foreach ($regions as $key => $item)
                    <div class="px-3 py-1 duration-300 bg-gray-500 hover:-translate-y-1 hover:bg-gray-500 rounded-full cursor-pointer">
                        {{ $key }}
                    </div>
                @endforeach
            </div>
