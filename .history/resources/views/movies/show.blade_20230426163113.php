    ...
    >
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots mt-6 relative" x-on:mouseenter="navigation = true" x-on:mouseleave="navigation = false">
                ...
                <!-- Prev -->
                <div class="screenshot-prev absolute h-4/5 mt-1 top-0 left-0 z-50 bg-white bg-opacity-30 hover:bg-opacity-100 px-2 flex rounded-full transition duration-300 cursor-pointer" style="display: none;" x-show="navigation" x-transition>
                    <i class="fa-solid fa-arrow-left text-black text-5xl my-auto"></i>
                </div>
                <!-- Next -->
                <div class="screenshot-next absolute h-4/5 mt-1 top-0 right-0 z-50 bg-white bg-opacity-30 hover:bg-opacity-100 px-2 flex rounded-full transition duration-300 cursor-pointer" style="display: none;" x-show="navigation" x-transition>
        ...
        <!-- Thumbnail Modal -->
        <div class="fixed inset-0 z-20 bg-black/70" style="display: none" x-show="imageModalOpen" x-transition:enter="transition ease-out duration-500" x-transition:leave="transition ease-in duration-500">
            ...
            <div class="flex justify-center align-middle w-12/12 md:w-11/12 xl:w-8/12 mx-auto mt-72 md:mt-56 xl:mt-36" @click.outside="imageModalOpen = false">
                ...
                <div class="swiper thumbnailsw" x-show="imageModalOpen" style="display: none">
                    <div class="swiper-wrapper">
...
<script>
    var swiper_thumbnails = new Swiper(".thumbnailsw", {
