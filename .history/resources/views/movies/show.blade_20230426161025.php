...
<div x-data="{
    ...
    <div class="Thumbnail border-b border-gray-800" 
        x-data="{ imageModalOpen: false, imageSrc: '', navigation: true}"
    >
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Screenshots</h2>
            <!-- Start Swiper -->
            <div class="swiper-screenshots mt-6 relative" x-on:mouseenter="navigation = true">
                ...
                <!-- Prev -->
                <div class="screenshot-prev absolute h-4/5 mt-1 top-0 left-0 z-50 bg-white bg-opacity-30 hover:bg-opacity-100 px-2 flex rounded-full" x-bind:class="{ 'hidden': navigation }">
