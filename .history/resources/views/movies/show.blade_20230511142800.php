        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="relative outline w-full">
                ...
                <div class="absolute left-0 top-1/2 transform -translate-y-1/2  z-50">
                    <i class="actor-prev fa-solid fa-circle-chevron-left text-6xl opacity-40 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                </div>
                <!-- Next -->
                <div class="absolute right-0 top-1/2 transform -translate-y-1/2  z-50">
                    <i class="actor-next fa-solid fa-circle-chevron-right text-6xl opacity-40 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                </div>
            </div>
