                ...
                <div class="flex items-center text-gray-400 mt-1">
                    ...
                    @isset($movie['is_rated'])
                        ...
                        <span class="ml-5 mr-3">
                            <i class="fa-solid fa-thumbs-up fa-xl @if ($movie['is_rated'] === 'good') text-green-700 @else text-gray-700 pointer-events-none @endif"></i>
                        </span>
                        <span >
                            <i class="fa-solid fa-thumbs-down fa-xl @if ($movie['is_rated'] === 'bad') text-red-500 @else text-gray-700 pointer-events-none @endif"></i>
                        </span>
                    @else
                        <!-- Not Rated Yet -->
                        <span class="ml-5 mr-3">
