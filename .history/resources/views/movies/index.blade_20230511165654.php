...
<div class="container mx-auto px-4 pt-16">
    <div class="movies-filter w-full bg-gray-800 px-3 py-5 rounded-lg flex justify-start align-middle gap-5">
        ...
        <div class="rounded-xl px-5 py-1 text-gray-300 cursor-pointer underline-offset-3 hover:bg-slate-700 duration-300 bg-gray-700 underline cursor-none">All</div>
