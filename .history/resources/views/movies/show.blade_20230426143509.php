    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots mt-6 relative">
                ...
                <div class="absolute h-4/5 mt-1 top-0 left-0 z-50 bg-white px-2 rounded-full text-center flex align-middle justify-center">
                    <i class="fa-solid fa-arrow-left text-black text-5xl my-auto py-auto text-center "></i>
                </div>
            </div>
