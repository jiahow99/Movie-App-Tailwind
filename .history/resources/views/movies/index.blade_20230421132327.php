        ...
        <div class="popular-movies">
            <div class="flex justify-between">
                <a href="{{ route('movies.popular') }}">
                    <h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold mb-4 after:content-[''] after:bg-[rgb(2,0,36)] after:bg-gradient-to-r after:from-sky-500 after:to-indigo-500 after:w-[0%] after:left-0 after:-bottom-[3px] after:h-[4px] after:absolute transition-all after:duration-300 hover:after:w-[100%]">Popular Movies</h2>
                </a>
