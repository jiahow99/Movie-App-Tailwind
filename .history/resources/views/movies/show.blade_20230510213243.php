        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div id="gallery" class="grid grid-cols-1 md:grid-cols-2 gap-10" >
                @foreach ($movie['images']['backdrops'] as $image)
                    ...
                    <a class="lightgallery-lazy" href="{{ asset('image/movie_placeholder.jpg') }}" data-lazy-src="https://image.tmdb.org/t/p/original/{{ $image['file_path'] }}" loading="lazy">
...
<script>
    ...
    // Select all the <a> tags with the data-lazy-src attribute
    const links = document.querySelectorAll('.lightgallery-lazy');
