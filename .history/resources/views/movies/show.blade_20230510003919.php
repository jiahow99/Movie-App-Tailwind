                ...
                @isset($movieCollections)
                    <div class="mt-8 w-[900px] relative">
                        ...
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-50">
                            <i class="collection-prev fa-solid fa-circle-chevron-left text-6xl opacity-60 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                        </div>
                        <!-- Next -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-50">
                            <i class="collection-next fa-solid fa-circle-chevron-right text-6xl opacity-60 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                        </div>
                    </div>
                @endisset
