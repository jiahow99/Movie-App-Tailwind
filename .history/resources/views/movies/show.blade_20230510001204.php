        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                @isset($movieCollections)
                    <div class="mt-8 w-5/6 relative outline overflow-visible">
                        <!-- Swiper Start -->
                        <div class="swiper movieCollections w-[900px]">
...
<script>
    ...
    var swiper_movie_collections = new Swiper(".movieCollections", {
        slidesPerView: 3,
        spaceBetween: 30,
        // navigation: {
