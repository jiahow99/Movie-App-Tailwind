    ...
    >
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots mt-6 relative" x-on:mouseenter="navigation = true" x-on:mouseleave="navigation = false">
                ...
                <!-- Prev -->
                <div class="screenshot-prev absolute h-4/5 mt-1 top-0 left-0 z-50 bg-white bg-opacity-30 hover:bg-opacity-100 px-2 flex rounded-full transition-all duration-200" x-bind:class="{ 'hidden': !navigation }">
