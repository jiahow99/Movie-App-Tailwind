...
<style>
    .swiper_screenshots .swiper-slide {
        text-align: center;
    ...
    .movieCollections .swiper-slide img {
        display: block;
        width: 100%;
        height: 100%;
        object-fit: cover;
...
@section('content')
                ...
                @isset($movieCollections)
                    <div class="w-5/6 relative ">
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-50">
                            <i class="fa-solid fa-circle-chevron-left text-6xl opacity-60 hover:opacity-80 cursor-pointer text-zinc-500  rounded-full"></i>
                        </div>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-50">
                            <i class="fa-solid fa-circle-chevron-right text-6xl opacity-60 hover:opacity-80 cursor-pointer text-zinc-500  rounded-full"></i>
                        </div>
                        <div class="mt-10 xl:w-[600px] h-fit">
    ...
    >
        <div class="container mx-auto px-4 py-16">
            ...
            <!-- Start Swiper -->
            <div class="swiper_screenshots mt-6 relative" x-on:mouseenter="navigation = true" x-on:mouseleave="navigation = false">
                <div class="swiper-wrapper ">
...
<script>
    ...
    // Screenshots swiper
    var swiper_screenshots = new Swiper(".swiper_screenshots", {
        slidesPerView: 3,
        loop: true,
        grid: {
            rows: 2,
    ...
    var movie_collections = new Swiper(".movieCollections", {
      slidesPerView: 3,
      spaceBetween: 30,
      pagination: {
        el: ".swiper-pagination",
