        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div id="gallery" class="grid grid-cols-1 md:grid-cols-2 gap-10" >
                @foreach ($movie['images']['backdrops'] as $image)
                    ...
                    <a href="{{ asset('image/movie_placeholder.jpg') }}" data-lazy-src="https://image.tmdb.org/t/p/original/{{ $image['file_path'] }}" loading="lazy">
...
<script>
    ...
    const links = document.querySelectorAll('a[data-lazy-src]');
