...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                @isset($movieCollections)
                    <div class="mt-8 xl:w-[900px] outline relative">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="{{ route('movie.show', $movieCollection['id']) }}">
                                        <img class="duration-300 hover:scale-110" src="{{ $movieCollection['poster_path'] }}" alt="movie_poster">
                                    </a>
                                </div>
                                @endforeach
                            </div>
    ...
    >
        <div class="container mx-auto px-4 py-16">
            ...
            <!-- Mobile view -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 block xl:none">
