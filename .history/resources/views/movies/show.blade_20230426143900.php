    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots mt-6 relative">
                ...
                <div class="absolute h-4/5 mt-1 top-0 left-0 z-50 bg-white bg-opacity-30 hover:opacity- px-2 flex rounded-full">
                    <i class="fa-solid fa-arrow-left text-black text-5xl my-auto  "></i>
                </div>
                <div class="absolute h-4/5 mt-1 top-0 right-0 z-50 bg-white bg-opacity-30 hover:opacity- px-2 flex rounded-full">
