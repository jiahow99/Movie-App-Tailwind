        ...
        <div class="container mx-auto px-4 py-16 flex flex-col xl:flex-row">
            ...
            <div class="mt-6 xl:mt-0 xl:ml-24">
                ...
                @isset($movieCollections)
                    <div class="mt-8 w-[900px] relative">
                        <!-- Swiper Start -->
                        ...
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-50">
                            <i class="collection-prev fa-solid fa-circle-chevron-left text-6xl opacity-50 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                        </div>
                        <!-- Next -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-50">
                            <i class="collection-next fa-solid fa-circle-chevron-right text-6xl opacity-50 hover:opacity-80 cursor-pointer text-slate-50  rounded-full"></i>
                        </div>
                    </div>
                @endisset
