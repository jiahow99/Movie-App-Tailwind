    ...
    >
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="swiper-screenshots mt-6 relative hidden xl:block" x-on:mouseenter="navigation = true" x-on:mouseleave="navigation = false">
                <div id="gallery1" class="swiper-wrapper">
                    @foreach ($movie['images']['backdrops'] as $index=>$image)
                        <div class="swiper-slide">
                            <a href="{{ asset('image/image1.jpg') }}">
                                <img src="{{ asset('image/image1.jpg') }}" alt="{{ $movie['title'] }}_thumbnail" data-index="{{ $index }}">
                            </a>
                        </div>
                     @endforeach
                </div>
            ...
            <!-- Mobile view -->
            <div id="gallery2" class="grid grid-cols-1 md:grid-cols-2 gap-10" >
