...
<div x-data="{
    ...
    x-data="{ imageModalOpen: false, imageSrc: '' }" x-show="imageModalOpen">
        <div class="container mx-auto px-4 py-16">
        ...
        {{-- Thumbnail Modal --}}
        <div class="fixed inset-0 flex justify-center items-center z-20 bg-black/70" x-show="imageModalOpen" x-transition x-cloak>
            ...
            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2 w-[1000px]" x-show="imageModalOpen">
              ...
              <div thumbsSlider="" class="swiper mySwiper w-[1000px]" x-show="imageModalOpen">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="{{ asset('image/image1.jpg') }}" />
                  </div>
