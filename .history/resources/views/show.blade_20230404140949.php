...
<div x-data="{
    ...
    <div class="Thumbnail border-b border-gray-800" x-data="imageModalOpen: false, imageSrc: ''">
        ...
        <div class="fixed inset-0 flex justify-center items-center">
            <div class="bg-slate-800 w-[800px] h-[500px] relative">
                <div class="w-full text-right pr-5 absolute z-20 cursor-pointer">X</div>
                <img src="{{ asset('image/image1.jpg') }}" alt="{{ $movie['title'] }}_thumbnail" class="max-w-full max-h-full">
            </div>
        </div>
    </div>
</div>
