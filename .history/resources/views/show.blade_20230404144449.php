...
<div x-data="{
    ...
    <div class="Thumbnail border-b border-gray-800" x-data="imageModalOpen: true, imageSrc: ''">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap:0 xl:gap-10">
                ...
                @foreach (array_reverse($movie['images']['backdrops']) as $image)
                    @if ($loop->index < 6)
                        ...
                        imageSrc = https://image.tmdb.org/t/p/w500/{{ $image['file_path'] }}
                        ">
        ...
        {{-- Thumbnail Modal --}}
        <div class="fixed inset-0 flex justify-center items-center z-20 bg-black/70" x-show="imageModalOpen" x-cloak>
