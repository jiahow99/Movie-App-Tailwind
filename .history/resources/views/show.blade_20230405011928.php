    ...
    x-data="{ imageModalOpen: true, imageSrc: '' }">
        ...
        <div class="fixed inset-0 z-20 bg-black/70" x-show="imageModalOpen" x-transition>
            ...
            <div class="flex justify-center align-middle w-8/12 mx-auto mt-36">
                <div class="my-auto mx-5">prev</div>
                ...
                <div class="my-auto mx-5"><i class="fa-solid fa-caret-right text-gray-800 text-4xl cursor-pointer rounded-full bg-white px-4" style=""></i></div>
            </div>
        </div>
    </div>
</div>
