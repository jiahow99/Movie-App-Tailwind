...
<div class="register-form flex justify-center align-middle">
    <div>
        <!-- login modal -->
        <div class="register-box w-[800px] mt-4 pt-2 pb-10 px-8">
            ...
            <div class="flex justify-between gap-5">
                ...
                <!-- Start Social Login -->
                <div class="basis-1/2 border-l border-neutral-600 pl-5">
                    <!-- Social media login -->
                    <a href="{{ route('facebook.login') }}">
                        <div class="facebook w-full py-3 bg-blue-600 hover:bg-blue-800 duration-300 text-center rounded-md mt-3">
                            <i class="fa-brands fa-facebook-f text-white mr-2"></i>
                            <span class="text-sm">Log in with Facebook</span>
                        </div>
                    </a>
                    <a href="{{ route('google.login') }}">
                        <div class="google w-full flex justify-center align-middle py-3 bg-white hover:bg-slate-300 duration-300 text-center rounded-md mt-3">
                    ...
                    <a href="{{ route('github.login') }}">
                        <div class="github w-full flex justify-center align-middle py-3 bg-[#f5f5f5] hover:bg-slate-300 duration-300 text-center rounded-md mt-3">
