...
class MovieApiService
{
     ...
     */
    public function fetchPopularMovies(string $max_page = 1)
    {
     ...
     * Fetch popular movies.
     */
    public function fetchNowPlaying(string $max_page = 1)
    {
     ...
     */
    public function popularLoadMore(string $page)
    {
        // Fetch data from API
     ...
     */
    public function nowPlayingLoadMore(string $page)
    {
        // Fetch data from API
