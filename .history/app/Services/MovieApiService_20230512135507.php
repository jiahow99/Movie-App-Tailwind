...
class MovieApiService
{
    ...
    public function fetchRegionMovies(string $region)
    {
        ...
        if( !Redis::exists('movies:'.$regionCode) )
        {
            $url = "https://api.themoviedb.org/3/discover/movie?with_original_language=".$regionLanguage."&region=KR&with_production_countries=KR"
        }
