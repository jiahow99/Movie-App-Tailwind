    ...
    public function fetchRegionMovies(string $region)
    {
        ...
        if( !Redis::exists($redisCacheName) )
        {
            ...
            if( is_array($regions[$region]['language']) )
            {
                ...
                $url1 = "https://api.themoviedb.org/3/discover/movie?with_original_language=".$regionLanguage."&region=".$regionCode."&with_production_countries=".$regionCode;
                $url2 = "https://api.themoviedb.org/3/discover/movie?with_original_language=".$regionLanguage."&region=".$regionCode."&with_production_countries=".$regionCode;
            }
