...
class MovieApiService
{
    ...
    public function fetchPopularMovies($max_page = 1)
    {
        ...
        //     // Redis::setEx('movies:popular', 1800, ['last_updated' => time(), 'data' => $popularMovies]);
        //     Redis::setEx('movies:popular', 1800, json_encode($popularMovies));
        // }

        // // return Redis::hget('movies:popular', 'data');
  
        // $data =  Redis::get('movies:popular');
