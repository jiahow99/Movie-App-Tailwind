...
class ActorViewModel extends ViewModel
{
    ...
    public function actor(){
        ...
        $formattedActor = array_replace($this->actor, [
            ...
            $external_ids = $this->actor['external_ids'] ?? null ;

            'facebook' = isset($external_ids['facebook_id']) 
                ? 'https://www.facebook.com/'.$external_ids['facebook_id']
                : null;

            'instagram' = isset($external_ids['instagram_id']) 
                ? 'https://www.instagram.com/'.$external_ids['instagram_id']
                : null;

            'twitter' = isset($external_ids['twitter_id']) 
