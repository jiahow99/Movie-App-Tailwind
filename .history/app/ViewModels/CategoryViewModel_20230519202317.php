...
class CategoryViewModel extends ViewModel
{
    ...
    public function __construct($category, $moviesByCategory, $genresList, $filterType, $filterData=null, $filterInput=null)
    {
    ...
    {
        if( isset($this->filterInput) && isset($this->filterInput['year'] != null))
        {
