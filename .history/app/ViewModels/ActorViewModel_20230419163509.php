...
class ActorViewModel extends ViewModel
{
    ...
    public function actor(){
        ...
        $formattedActor['read_more'] = implode(" ", $chunks[1]);

        return collect($formattedActor)->only(['biography', 'birthday', 'id', 'name', 'place_of_birth', 'profile_path', 'facebook', 'instagram', 'twitter', 'age'])->dump();
    }
