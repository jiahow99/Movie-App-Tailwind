...
class ActorViewModel extends ViewModel
{
    ...
    public function credits(){
        ...
        $newCastArray = array_map(function($cast){
            ...
            $cast['external_ids']['facebook_id'] = isset($cast['external_ids']['facebook_id']) 
                ? 'https://www.facebook.com/'.$cast['external_ids']['facebook_id']
                : null;

                $cast['external_ids']['instagram_id'] = isset($cast['external_ids']['instagram_id']) 
                ? 'https://www.instagram.com/'.$cast['external_ids']['instagram_id']
                : null;

                $cast['external_ids']['twitter_id'] = isset($cast['external_ids']['twitter_id']) 
