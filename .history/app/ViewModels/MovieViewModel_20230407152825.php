...
class MovieViewModel extends ViewModel
{
    ...
    public function movie(){
        ...
        $this->movie['vote_average'] = $this->movie['vote_average']*10 . "%";
        $this->movie['release_date'] = \Carbon\Carbon::parse($movie['release_date'])->format('M d, Y');
        $this->movie['genres'] = $genresFormatted;
        return $this->movie;
    }
}
