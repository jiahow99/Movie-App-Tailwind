...
class ActorViewModel extends ViewModel
{
    ...
    public function credits(){
        ...
        $newCastArray = array_map(function($cast){
            ...
            $cast['character'] = isset($cast['character']) ? $cast['character'] : 'unkown' ;
    ...
    public function cast_movies(){
        ...
        // Get top popular movie by each year
        $sorted_movies =  collect($newCastArray)->sortByDesc('popularity')->sortByDesc('release_year');

        return $sorted_movies->groupBy('release_year')->map(function($year){
            return $year->first();
        });
