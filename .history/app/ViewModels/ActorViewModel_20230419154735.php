...
class ActorViewModel extends ViewModel
{
    ...
    public function credits(){
        ...
        $newCastArray = array_map(function($cast){
            ...
            $external_ids['facebook_id'] = isset($external_ids['facebook_id']) 
                ? 'https://www.facebook.com/'.$external_ids['facebook_id']
                : null;

            $external_ids['instagram_id'] = isset($external_ids['instagram_id']) 
                ? 'https://www.instagram.com/'.$external_ids['instagram_id']
                : null;

            $external_ids['twitter_id'] = isset($external_ids['twitter_id']) 
