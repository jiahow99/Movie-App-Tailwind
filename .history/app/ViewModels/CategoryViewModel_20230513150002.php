...
class CategoryViewModel extends ViewModel
{
    ...
    public function __construct($category, $moviesByCategory, $genresList, $filter=null, $filterData=null)
    {
    ...
    {
        if( isset($this->filter) && $this->filter == 'regions' && isset($this->filterData))
        {
