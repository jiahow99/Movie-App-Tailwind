...
class ActorViewModel extends ViewModel
{
    ...
    public function actor(){
        ...
        return collect($formattedActor)->only(['biography', 'birthday', 'id', 'name', 'place_of_birth', 'profile_path', 'facebook', 'instagram', 'twitter', 'age', 'read_more'])->dump();
    }
    ...
    public function credits(){
        ...
        $newCastArray = array_map(function($cast){
            ...
            return collect($cast)->only(['title', 'poster_path', 'facebook', 'instagram', 'twitter', 'id']);
