...
class MovieController extends Controller
{
    ...
    {
        $filters = request()->except('regions');

        // Fetch movies by Region
        $moviesByRegion = $movieApi->fetchRegionMovies($region, $page, $filters);
        ...
        // View model
        $viewModel = new CategoryViewModel($region, $moviesByRegion, $genresList, $filterData);
