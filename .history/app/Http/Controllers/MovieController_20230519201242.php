...
class MovieController extends Controller
{
    ...
    public function category(MovieApiService $movieApi, string $category, int $page=1)
    {
        ...
        // View model
        $viewModel = new CategoryViewModel($category, $moviesByCategory, $pageType, $filterType);
    ...
    public function moviesByRegion(MovieApiService $movieApi, string $region, $page=1)
    {
        ...
        // View model
        $viewModel = new CategoryViewModel($region, $moviesByRegion, $genresList, $pageType, $filterData, $filterInput);
