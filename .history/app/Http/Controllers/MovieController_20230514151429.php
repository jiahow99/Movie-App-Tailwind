...
class MovieController extends Controller
{
    ...
    public function index(Request $request, MovieApiService $movieApi)
    {
        ...
        $years = $movieApi->fetchYears();

        $viewModel = new MoviesViewModel($popularMovies, $nowPlaying, $topRated, $genresArray, $regions. $years);
    ...
    public function moviesByRegion(MovieApiService $movieApi, string $region, $page=1)
    {
        ...
        // View model
        $viewModel = new CategoryViewModel($region, $moviesByRegion, $genresList, 'region', $regions);
